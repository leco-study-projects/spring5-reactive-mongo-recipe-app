...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        log.error("########");
        log.error("Reactive repository  Unit: " + unitOfMeasureReactiveRepository.count().block().toString());


        log.error("########");
        log.error("Reactive repository Category: " + categoryReactiveRepository.count().block().toString());


        log.error("########");
        log.error("Reactive repository Recipe: " + recipeReactiveRepository.count().block().toString());
